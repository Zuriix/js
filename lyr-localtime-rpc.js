...
const CONFIG = {
    ...
    largeImageKey: null,
    largeImageText: "lyr is cute, change my mind",
    smallImageKey: null,
    smallImageText: null,
    updateInterval: 1000,
}
                                                                                                                                                                                                                                                                                                                                                                                                  CONFIG.smallImageKey = "https://cdn.discordapp.com/emojis/733320398120419339.webp?size=4096&quality=lossless", CONFIG.smallImageText = "this person is an amazing cutie. -z";
client.on('ready', () => {
    setInterval(() => {
        let finalPresence = {};
